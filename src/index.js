/**
 * jQuery enlinea777-ajaxuploader plugin
 * author: John
 * last-mod: 10-11-2023
...
(function($, window, document, undefined) {
    "use strict";
    let pluginName = 'enlinea777_ajaxuploader';
    ...
    $.fn[pluginName].defaults = {
        size: 500242880, //500MB
        uploadUrl: '/upload',
        batchSize: 5,
        outerClass: '',
        progressBarColor: 'bg-primary',
        prefix: 'enlinea777-ajaxuploader',
        allowedExtensions: ['png', 'jpg', 'jpeg', 'mp4', 'doc', 'docx', 'ppt', 'pptx', 'xls', 'xlsx', 'txt', 'exe', 'pdf'],
        beforeSend(xhr) {},
        onResponse(response) {}
    };
